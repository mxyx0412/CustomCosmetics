...
public static class CustomVisorManager
{
    ...
    internal static VisorData CreateVisorBehaviour(CustomVisorConfig config)
    {
        ...
        if (config.Adaptive && DestroyableSingleton<HatManager>.Instance?.PlayerMaterial != null)
            viewData.AltShader = DestroyableSingleton<HatManager>.Instance.PlayerMaterial;
