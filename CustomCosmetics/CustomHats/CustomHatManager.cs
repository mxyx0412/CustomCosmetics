...
public static class CustomHatManager
{
    ...
    private static Material _cachedShader;
    ...
    {
        if (_cachedShader == null) _cachedShader = DestroyableSingleton<HatManager>.Instance.PlayerMaterial;
        ...
        hat.Free = true;
        if (ch.Adaptive && _cachedShader != null)
            viewData.AltShader = _cachedShader;
